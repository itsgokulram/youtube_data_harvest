...
channel_button = st.sidebar.button("Extract Full data")
...
if channel_button:
        ...
        for document in mongo_data:
            ...
            for comment in document["videos"]:
                ...
                for comments in comment["comments"]:
                    ...
                    comment_id, playlist_id, video_id, comment_text, comment_author, comment_published_date
                    ) VALUES(
                    %s, %s, %s, %s, %s
                    )"""

                    sql_values3 = (
                        Comment_Id, Playlist_id, Video_Id, Comment_Text, Comment_Author, Comment_PublishedAt
                    )
    ...
    st.write("Data stored and migrated to SQL")

# Importing and assigning sql queries from sqlquery file
...
selected = st.sidebar.selectbox("Select a query:", list(options.values()))
